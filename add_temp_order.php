...
$(document).ready(function () {
    ...
    function renderItemsTable(data) {
        let html = '<table class="table table-light"><thead><tr><th>ردیف</th><th>نام محصول</th><th>تعداد</th><th>قیمت واحد</th><th>اضافه فروش</th><th>قیمت کل</th><th>قیمت فاکتور</th><th>عملیات</th></tr></thead><tbody>';
        ...
        html += `<tr><td colspan="5">جمع کل</td><td>${Number(data.total_amount).toLocaleString('fa')} تومان</td><td colspan="2"></td></tr>`;
        html += '</tbody></table>';
