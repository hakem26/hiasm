...
<div class="container-fluid mt-5">
    ...
    <form id="add-temp-order-form">
        ...
        <div class="mb-3 position-relative">
            ...
            <div id="product_suggestions" class="product-suggestions list-group" style="display: none;"></div>
    ...
    document.addEventListener('DOMContentLoaded', () => {
            ...
            if (query.length >= 3) {
                $.ajax({
                    ...
                    success: function (response) {
                        console.log('get_products response:', response); // دیباگ پاسخ
        ...
        $(document).on('click', '.product-suggestion', function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    console.log('get_inventory response:', response); // دیباگ موجودی
                    if (response.success) {
